...
def args_parser():
    ...
    parser.add_argument('--local_sup_ep', type=int,
                        default=1, help='local supervised epoch')
    parser.add_argument('--local_unsup_ep', type=int,
                        default=1, help='local unsupervised epoch')
    ...
    parser.add_argument('--input_shape', type=tuple, default=(3, 32, 32), help='input shape')
    ...
    parser.add_argument('--unsup_lr', type=float, default=0.01,
